HA$PBExportHeader$n_icontray_cross.sru
$PBExportComments$Icon System Tray functions
forward
global type n_icontray_cross from nonvisualobject
end type
type guid from structure within n_icontray_cross
end type
type notifyicondata from structure within n_icontray_cross
end type
type dllversioninfo from structure within n_icontray_cross
end type
type point from structure within n_icontray_cross
end type
end forward
...
global type n_icontray_cross from nonvisualobject autoinstantiate
end type
...
on n_icontray_cross.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_icontray_cross.destroy
